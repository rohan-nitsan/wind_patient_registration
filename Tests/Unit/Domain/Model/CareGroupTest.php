 ...
 * Test case
 */
class CareGroupTest extends UnitTestCase
{
    /**
     * @var \WIND\WindPatientRegistration\Domain\Model\CareGroup|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \WIND\WindPatientRegistration\Domain\Model\CareGroup::class,
            ['dummy']
        );
    }
